    ...
    <div class="cart-payment">
        ...
        <noscript class="cart-payment__noscript">
            <div class="message message--info">
                <?php esc_html_e( 'Since your browser does not support JavaScript, or it is disabled, please ensure you click the <em>Update Totals</em> button before placing your order. You may be charged more than the amount stated above if you fail to do so.', 'saleszone' ); ?>
            </div>
