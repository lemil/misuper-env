...
if ( isset( $premmerce_wishlist_frontend ) ) {
    ...
    add_action( 'saleszone_loop_product_cut_after_title', array( $premmerce_wishlist_frontend, 'renderWishListMoveBtn' ), 10 );
    add_action( 'saleszone_loop_product_cut_before_title_right', array( $premmerce_wishlist_frontend, 'renderWishListDeleteBtn' ), 10 );
}
