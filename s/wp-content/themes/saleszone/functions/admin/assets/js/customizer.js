...
jQuery(function($){
  ...
  wp.customize('header-phone-title-font-size',function (e) {
    e.bind(function (value) {
      var value = parseInt(value);
      ...
      if(!isNaN(value)){
        insertStyle('header-phone-title-font-size', function () {
          return '.pc-header-phones__phone-title,.pc-header-phones-drop__phone-title{font-size:'+ value +'px!important;}';
        });
